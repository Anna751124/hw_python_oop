...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        return ((self.K1 * self.weight + ((self.get_mean_speed() * self.KH_H_TO_M_SEC) ** 2 / (self.height * self.SM_TO_M)) * self.K2 * self.weight) * self.duration * self.MIN_IN_HOUR)
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        return((self.get_mean_speed() + self.S1)
               * self.S2
               * self.weight)              
